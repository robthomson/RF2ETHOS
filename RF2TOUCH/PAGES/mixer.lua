...
fields[#fields + 1] = { t = "Geo correction",           label=1  ,min = -125,  max = 125,  vals = { 19 }, decimals=1, scale = 5 }
fields[#fields + 1] = { t = "Total pitch limit",        label=1  ,min = 0,     max = 3000, vals = { 10, 11 }, decimals=3, scale = 83.33333333333333 }
