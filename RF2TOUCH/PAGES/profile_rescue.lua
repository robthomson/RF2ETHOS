...
labels[#labels + 1] = {subpage = 1, t = "Pull-up", label = "pullup", inline_size = 12}
...
labels[#labels + 1] = {subpage = 1, t = "Climb", label = "climb", inline_size = 12}
...
labels[#labels + 1] = {subpage = 1, t = "Hover", label = "hover", inline_size = 12}
fields[#fields + 1] = {t = "Collective", inline = 2, label = "hover", min = 0, max = 1000, default = 350, unit = "%", vals = {13, 14}, decimals = 1, scale = 10}

labels[#labels + 1] = {subpage = 1, t = "Flip", label = "flip", inline_size = 12}
