...
fields[#fields + 1] = {t = "Accel", help = "profilesRatesDynamicsAcc", inline = 1, subpage = 2, label = "rolldynamics", min = 0, max = 50000, vals = {6, 7}, unit = "°/s"}
...
fields[#fields + 1] = {t = "Accel", help = "profilesRatesDynamicsAcc", inline = 1, subpage = 2, label = "pitchdynamics", min = 0, max = 50000, vals = {12, 13}, unit = "°/s"}
...
fields[#fields + 1] = {t = "Accel", help = "profilesRatesDynamicsAcc", inline = 1, subpage = 2, label = "yawdynamics", min = 0, max = 50000, vals = {18, 19}, unit = "°/s"}
...
fields[#fields + 1] = {t = "Accel", help = "profilesRatesDynamicsAcc", inline = 1, subpage = 2, label = "coldynamics", min = 0, max = 50000, vals = {24, 25}, unit = "°/^s", mult = 10}
