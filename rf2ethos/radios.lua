...
local supportedRadios = {
    ...
    ["784x406"] = {msp = {template = "/scripts/rf2ethos/templates/784x406.lua", inlinesize_mult = 1, text=1, helpQrCodeSize=100, navbuttonHeight=40, text = 1, buttonsPerRow = 5, buttonsPerRowSmall = 6, buttonWidth = 135, buttonHeight = 140, buttonPadding = 23, buttonWidthSmall = 120, buttonHeightSmall = 120, buttonPaddingSmall = 10, linePaddingTop = 8}},
