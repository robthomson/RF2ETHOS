local 
    ...
    0x0D
local 
    SMARTPORT_REMOTE_SENSOR_ID =
    0x1B
local 
    FPORT_REMOTE_SENSOR_ID =
    0x00
local 
    REQUEST_FRAME_ID =
    0x30
    ...
    function()
        while true do
            local 
                ...
                dataId,
                value =
                smartPortTelemetryPop()
            if (sensorId ==
                SMARTPORT_REMOTE_SENSOR_ID or
                sensorId ==
                FPORT_REMOTE_SENSOR_ID) and
                frameId ==
                REPLY_FRAME_ID then
