local supportedProtocols = {
    smartPort = {mspTransport = "msp/sp.lua", push = rf2ethos.sportTelemetryPush, maxTxBufferSize = 6, maxRxBufferSize = 6, maxRetries = 6, saveTimeout = 10.0, pageReqTimeout = 10},
