...
function utils.storePreference(
    preference,
    value)
...
function utils.getInlinePositions(
    f,
    lPage)
    local 
        tmp_inline_size =
...
function utils.convertPageValueTable(
    tbl,
    inc)
    local 
        thetable =
