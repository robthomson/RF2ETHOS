...
labels[#labels + 1] = {t = "Roll dynamics", subpage = 2, label = "rolldynamics", inline_size = 15.6}
...
labels[#labels + 1] = {t = "Pitch dynamics", label = "pitchdynamics", inline_size = 15.6}
...
labels[#labels + 1] = {t = "Yaw dynamics", label = "yawdynamics", inline_size = 15.6}
...
labels[#labels + 1] = {t = "Collective dynamics", label = "coldynamics", inline_size = 15.6}
