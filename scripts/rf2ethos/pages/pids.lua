...
-- O
fields[#fields + 1] = {help = "profilesHSI", row = 1, col = 3, min = 0, max = 1000, default = 25, vals = {31, 32}}
fields[#fields + 1] = {help = "profilesHSI", row = 2, col = 3, min = 0, max = 1000, default = 25, vals = {33, 34}}

-- D
fields[#fields + 1] = {help = "profilesDerivative", row = 1, col = 4, min = 0, max = 1000, default = 10, vals = {5, 6}}
fields[#fields + 1] = {help = "profilesDerivative", row = 2, col = 4, min = 0, max = 1000, default = 20, vals = {13, 14}}
fields[#fields + 1] = {help = "profilesDerivative", row = 3, col = 4, min = 0, max = 1000, default = 10, vals = {21, 22}}
