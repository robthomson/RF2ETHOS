...
fields[#fields + 1] = {
    t = "ServoID (shown only for debug)",
    min = 0,
    max = 100,
    vals = {1}
}
...
return {
    ...
    fields = fields,
    simulatorResponse = {
        4, 180, 5, 12, 254, 244, 1, 244, 1, 244, 1, 144, 0, 0, 0, 1, 0, 160, 5,
        12, 254, 244, 1, 244, 1, 244, 1, 144, 0, 0, 0, 1, 0, 14, 6, 12, 254,
        244, 1, 244, 1, 244, 1, 144, 0, 0, 0, 0, 0, 120, 5, 212, 254, 44, 1,
        244, 1, 244, 1, 77, 1, 0, 0, 0, 0
    },
    postRead = function(self)
        ...
        for i = 1, self.servoCount do
            ...
            for j = 1, 16 do
                self.servoConfiguration[i][j] =
                    self.values[1 + (i - 1) * 16 + j]
            end
        end
