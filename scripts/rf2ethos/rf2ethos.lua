...
triggers.triggerSAVE =
    false
triggers.triggerRELOAD =
    false
triggers.triggerESCRELOAD =
    false
triggers.triggerESCMAINMENU =
    false
triggers.triggerESCLOADER =
    false
triggers.triggerMAINMENU =
    false
triggers.escPowerCycle =
    false
triggers.escPowerCycleAnimation =
    nil
triggers.escPowerCycleLoader =
    0
triggers.mspDataLoaded =
    false
triggers.isSaving =
    false
triggers.wasSaving =
    false
triggers.wasReloading =
    false
triggers.closinghelp =
    false
triggers.saveFailed =
    false
triggers.telemetryState =
    nil
triggers.reloadRates =
    false
triggers.resetRates =
    nil
triggers.linkUPTime =
...
triggers.createForm =
    false
triggers.profileswitchLast =
    nil
triggers.rateswitchLast =
    nil
triggers.closeSave =
    false
...
rf2ethos.lastLabel =
    nil
rf2ethos.NewRateTable =
    nil
rf2ethos.RateTable =
    nil
rf2ethos.fieldHelpTxt =
    nil
rf2ethos.protocol =
    {}
rf2ethos.radio =
...
rf2ethos.runningInSimulator =
    system:getVersion().simulation
...
rf2ethos.getRSSI =
    function()
        ...
        if rf2ethos.rssiSensor ~=
            nil and
            rf2ethos.rssiSensor:state() then
            -- this will return the last known value if nothing is received
            return
                rf2ethos.rssiSensor:value()
        end
...
function rf2ethos.getFieldValue(
    f)
...
function rf2ethos.sportTelemetryPush(
    sensorId,
    frameId,
    dataId,
    value)
...
function rf2ethos.resetCopyProfiles()
    if rf2ethos.lastScript ==
        "copy_profiles.lua" then
        -- invalidatePages
...
function rf2ethos.saveFieldValue(
    f,
    value)
    if value ~=
        nil then
...
rf2ethos.settingsSaved =
    function()
        ...
        if rf2ethos.Page and
            rf2ethos.Page
                .eepromWrite then
            -- don't write again if we're already responding to earlier page.write()s
            if rf2ethos.pageState ~=
                rf2ethos.pageStatus
                    .eepromWrite then
                rf2ethos.pageState =
                    rf2ethos.pageStatus
...
local 
    mspLoadSettings =
    {
        processReply = function(
            ...
            rf2ethos.utils
                .log(
                "rf2ethos.triggers.mspDataLoaded")
            rf2ethos.triggers
                .mspDataLoaded =
                true
...
rf2ethos.readPage =
    function()
        if type(
            ...
            mspLoadSettings.command =
                rf2ethos.Page
                    .read
            mspLoadSettings.simulatorResponse =
                rf2ethos.Page
                    .simulatorResponse
            rf2ethos.mspQueue:add(
                mspLoadSettings)
...
local function saveSettings()
    if rf2ethos.pageState ~=
        ...
        if rf2ethos.Page
            ...
            mspSaveSettings.command =
                rf2ethos.Page
                    .write
            mspSaveSettings.payload =
                payload
...
function rf2ethos.wakeup(
    ...
    if tonumber(
        ...
        if rf2ethos.dialogs
            ...
            if tonumber(
                ...
                form.openDialog(
                    "Warning",
                    config.ethosVersionString,
                    buttons,
                    1)
            else
                form.openDialog(
                    {
                        width = rf2ethos.config
                            .lcdWidth,
                        title = "Warning",
    ...
    if rf2ethos.uiState ==
        rf2ethos.uiStatus
            .pages then
        if rf2ethos.prevUiState ~=
            rf2ethos.uiState then
            rf2ethos.prevUiState =
                rf2ethos.uiState
        end
    ...
    if rf2ethos.uiState ~=
        ...
        if rf2ethos.config
            ...
            (rf2ethos.triggers
                .mspDataLoaded ==
                true and
                rf2ethos.mspQueue:isProcessed() and
                (rf2ethos.Page
                    .values)) then
            rf2ethos.triggers
                .mspDataLoaded =
    ...
    if rf2ethos.triggers
        .createForm ==
        true and
        rf2ethos.mspQueue:isProcessed() then
        ...
        elseif rf2ethos.triggers
            ...
            elseif rf2ethos.escMode ==
                ...
                rf2ethos.escScript ~=
                nil then
                rf2ethos.openESCFormLoader(
                    rf2ethos.escManufacturer,
                    rf2ethos.escScript)
            else
                rf2ethos.ui
                    .openPageDefaultLoader(
                    rf2ethos.lastIdx,
                    rf2ethos.lastSubPage,
                    rf2ethos.lastTitle,
                    rf2ethos.lastScript)
    ...
    if rf2ethos.triggers
        ...
        if rf2ethos.escMode ==
            true then
            theTitle =
                "SAVE SETTINGS TO ESC"
            theMsg =
                "Save current page to the speed controller"
        else
            theTitle =
                "SAVE SETTINGS TO FBL"
            theMsg =
                "Save current page to flight controller"
        end
        form.openDialog(
            {
                width = nil,
