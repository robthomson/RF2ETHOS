...
local escMode = {
    "Free (Attention!)", "Heli Ext Governor", "Heli Governor",
    "Heli Governor Store", "Aero Glider", "Aero Motor", "Aero F3A"
}
...
fields[#fields + 1] = {
    ...
    min = 1,
    max = #escMode,
    vals = {mspHeaderBytes + 3, mspHeaderBytes + 4},
    tableIdxInc = -1,
    table = escMode
}
...
fields[#fields + 1] = {
    ...
    min = 55,
    max = 84,
    vals = {mspHeaderBytes + 5, mspHeaderBytes + 6},
    scale = 10,
    decimals = 1
}
...
fields[#fields + 1] = {
    ...
    min = 0,
    max = #cuttoff,
    vals = {mspHeaderBytes + 17, mspHeaderBytes + 18},
    tableIdxInc = -1,
    table = cuttoff
}
