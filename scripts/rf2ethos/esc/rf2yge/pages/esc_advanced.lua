...
local motorTiming = {
    "Auto Normal", "Auto Efficient", "Auto Power", "Auto Extreme", "0 deg",
    "6 deg", "12 deg", "18 deg", "24 deg", "30 deg"
}
...
fields[#fields + 1] = {
    t = "Throttle Response",
    min = 0,
    max = #throttleResponse,
    tableIdxInc = -1,
    vals = {mspHeaderBytes + 15, mspHeaderBytes + 16},
    table = throttleResponse
}
...
fields[#fields + 1] = {
    ...
    max = #motorTiming,
    tableIdxInc = -1,
    vals = {mspHeaderBytes + 7, mspHeaderBytes + 8},
    table = motorTiming
}
fields[#fields + 1] = {
    t = "Active Freewheel",
    ...
    max = #freewheel,
    tableIdxInc = -1,
    vals = {mspHeaderBytes + 21, mspHeaderBytes + 22},
    table = freewheel
}
fields[#fields + 1] = {
    t = "F3C Autorotation",
...
local function bitExtract(value, field) return (value >> field) & 1 end
...
return {
    ...
    postLoad = function(self)
        ...
        local firmware = string.format("%.5f",
                                       getUInt(self, {25, 26, 27, 28}) / 100000)
