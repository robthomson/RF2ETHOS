...
fields[#fields + 1] = {subpage = 1, t = "R", inline = 3, label = 4, min = 0, max = 180, default = 30, unit = "°", vals = {8}}
fields[#fields + 1] = {subpage = 1, t = "P", inline = 2, label = 4, min = 0, max = 180, default = 30, unit = "°", vals = {9}}
fields[#fields + 1] = {subpage = 1, t = "Y", inline = 1, label = 4, min = 0, max = 180, default = 45, unit = "°", vals = {10}}

labels[#labels + 1] = {subpage = 1, t = "Offset limit", label = 5, inline_size=8.15}
fields[#fields + 1] = {subpage = 1, t = "R", inline = 3, label = 5, min = 0, max = 180, default = 45, unit = "°", vals = {37}}
fields[#fields + 1] = {subpage = 1, t = "P", inline = 2, label = 5, min = 0, max = 180, default = 45, unit = "°", vals = {38}}
...
fields[#fields + 1] = {subpage = 1, t = "P", inline = 2, label = 15, min = 1, max = 100, default = 10, vals = {19}}
fields[#fields + 1] = {subpage = 1, t = "Y", inline = 1, label = 15, min = 1, max = 100, default = 15, vals = {20}}
...
fields[#fields + 1] = {subpage = 3, t = "R", inline = 3, label = "pidbandwidth", min = 0, max = 250, default = 50, vals = {11}}
fields[#fields + 1] = {subpage = 3, t = "P", inline = 2, label = "pidbandwidth", min = 0, max = 250, default = 50, vals = {12}}
fields[#fields + 1] = {subpage = 3, t = "Y", inline = 1, label = "pidbandwidth", min = 0, max = 250, default = 100, vals = {13}}

labels[#labels + 1] = {subpage = 3, t = "D-term cut-off", inline_size=8.15,label = "dcutoff", type = 1}
fields[#fields + 1] = {subpage = 3, t = "R", inline = 3, label = "dcutoff", min = 0, max = 250, default = 15, vals = {14}}
fields[#fields + 1] = {subpage = 3, t = "P", inline = 2, label = "dcutoff", min = 0, max = 250, default = 15, vals = {15}}
fields[#fields + 1] = {subpage = 3, t = "Y", inline = 1, label = "dcutoff", min = 0, max = 250, default = 20, vals = {16}}

labels[#labels + 1] = {subpage = 3, t = "B-term cut-off", inline_size=8.15, label = "bcutoff", type = 1}
fields[#fields + 1] = {subpage = 3, t = "R", inline = 3, label = "bcutoff", min = 0, max = 250, default = 15, vals = {39}}
fields[#fields + 1] = {subpage = 3, t = "P", inline = 2, label = "bcutoff", min = 0, max = 250, default = 15, vals = {40}}
fields[#fields + 1] = {subpage = 3, t = "Y", inline = 1, label = "bcutoff", min = 0, max = 250, default = 20, vals = {41}}
